        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li><router-link to="/blog-post">Blog</router-link></li>
            </ul>
          </div>
        </div>
      </div>
                ...
                <div class="span8">
                  <div class="post-image">
                    <div class="post-heading">
                      <h3><router-link :to="`/blog-post/${post.id}`" href="#">{{post.title}}</router-link></h3>
                    </div>
                  ...
                  <div class="bottom-article">
                    ...
                    <router-link :to="`/blog-post/${post.id}`" class="pull-right">Continue reading <i class="icon-angle-right"></i></router-link>
                  </div>
                </div>
              </div>
            </article>
